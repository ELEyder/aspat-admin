...
export function CourseContentCard({
  ...
  return (
    <li
      ...
      style={style}
      {...attributes}
      className="flex items-center justify-between p-4 bg-neutro-950 rounded-lg border  hover:bg-black transition-colors gap-4 cursor-pointer"
    >
      ...
      <div className="flex gap-2">
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-40">
            <DropdownMenuItem
              onClick={() => navigate(`/course-contents/${content.id}`)}
            >
              <Edit /> Editar
            </DropdownMenuItem>
            <DropdownMenuItem
